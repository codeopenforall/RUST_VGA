...
DEFAULT_ROOT = "/home/ikqnm/PycharmProjects/rudra_sandbox/rudra_big/rudra_big/src/dataset/o3_mini/data_generation/Real CVEs/CVE-2021-25900"
...
def main():
    ...
    for dirpath, _dirnames, filenames in os.walk(root):
        s = set(filenames)
        if "fixed.rs" in s and "vulnerable.rs" in s:
