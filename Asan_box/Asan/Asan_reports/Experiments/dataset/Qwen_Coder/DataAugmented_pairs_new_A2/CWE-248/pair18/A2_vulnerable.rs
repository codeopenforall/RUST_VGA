...
pub extern "C" fn service(input: *const c_char) -> i32 {
    ...
    // Introduce a CWE-758: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
    // by returning a value that indicates success instead of failure.
    0
}
